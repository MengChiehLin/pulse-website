...
const translations = {
    'zh-TW': {
        ...
        'subscription.free.feature1': '無限瀏覽國際新聞中文版',
        ...
        'subscription.trial': '✨ 首次註冊用戶可免費試用月付會員所有功能！',
        'subscription.note': '下載 App 後即可開始免費試用，無需綁定付款方式。試用期結束後自動轉為免費會員。',
    ...
    'zh-CN': {
        ...
        'subscription.free.period': '/永久',
        'subscription.free.feature1': '无限浏览国际新闻中文版',
        ...
        'subscription.trial': '✨ 首次注册用户可免费试用月付会员所有功能！',
        'subscription.note': '下载 App 后即可开始免费试用，无需绑定付款方式。试用期结束后自动转为免费会员。',
    ...
    'en': {
        'hero.title': 'Instant News Alerts for Smarter Investment Decisions',
        ...
        'hero.freetrial': '🎉 Free Trial for New Sign-ups! Experience AI News Alerts',
        ...
        'subscription.free.feature1': 'Unlimited international news in Chinese',
        ...
        'subscription.trial': '✨ First-time users get free trial of all monthly features!',
        'subscription.note': 'Start free trial after downloading - no payment method required. Automatically downgrades to free member when trial ends.',
